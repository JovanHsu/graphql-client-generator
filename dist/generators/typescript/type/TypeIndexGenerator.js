...
exports.TypeIndexGenerator = void 0;
const BaseTypeScriptGenerator_1 = require("../BaseTypeScriptGenerator");
/**
 * 类型索引生成器
 * 负责生成类型索引文件
 */
class TypeIndexGenerator extends BaseTypeScriptGenerator_1.BaseTypeScriptGenerator {
...
exports.TypeIndexGenerator = TypeIndexGenerator;
